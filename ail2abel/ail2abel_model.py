...
class Encoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary):
        ...
        self.lm_code_head = self.build_lm_head(
            embed_dim=args.encoder_embed_dim,
            output_dim=len(dictionary[AIL_TOKEN_FIELD]),
    ...
    def build_lm_head(self, embed_dim, output_dim, activation_fn, weight):
        code_head = ClassificationHead(embed_dim, output_dim, activation_fn, weight)
        return code_head
...
@register_model("ail2abel")
class AIL2abelModel(FairseqEncoderModel):
    @classmethod
    def hub_models(cls):
        return {
            "trex.base": "",
...
@register_model_architecture("ail2abel", "ail2abel")
